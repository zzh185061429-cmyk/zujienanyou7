...
function AppContent() {
  ...
  return (
    <div 
      className="flex flex-col md:flex-row h-screen w-screen bg-pop-black overflow-hidden font-sans relative transition-all duration-300"
    ...
    >
        ...
        {/* Main Content Area */}
        <main className="flex-1 relative w-full h-[calc(100vh-5rem)] md:h-screen overflow-hidden bg-white">
