...
export function CalendarModal() {
  const { isCalendarOpen, setIsCalendarOpen } = useGameContext();
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-lg bg-white pop-border shadow-[8px_8px_0_#00e5ff] z-10 flex flex-col overflow-hidden clip-diagonal"
      >
        <div className="bg-pop-cyan text-pop-black p-4 flex justify-between items-center border-b-4 border-pop-black">
        ...
        <div className="p-6 bg-stripes relative max-h-[500px] overflow-y-auto hide-scrollbar">
          <div className="bg-white border-4 border-pop-black p-4 shadow-[4px_4px_0_#1a1a1a] clip-diagonal relative z-10">
            ...
            <div className="grid grid-cols-7 gap-1 md:gap-2 text-center font-bold">
              ...
              {Array.from({ length: daysInMonth }).map((_, i) => {
                ...
                const isToday = currentYear === 2026 && currentMonthIndex === 9 && day === 8;
